...
5. **eShamikh MCP Server (Model Context Protocol)**:
   - خادم سحابي مدمج يتيح لأدوات ومحررات الذكاء الاصطناعي (مثل Cursor و Windsurf و Claude Desktop) التفاعل البرمجي المباشر مع المنظومة وبناء لوحات تحكم خارجية.

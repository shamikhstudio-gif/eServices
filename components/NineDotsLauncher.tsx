...
export const ESERVICES_LIST: ServiceItem[] = [
  {
    id: 'elink',
    name: 'eLink',
    nameEn: 'Smart Links & QR',
    description: 'محرك الروابط الذكية ورموز QR الديناميكية مع فحص أمان فوري',
    category: 'core',
    status: 'active',
    icon: <Link2 size={20} />,
    href: '/services#elink',
  ...
  },
  {
    id: 'estore',
    name: 'eStore',
    nameEn: 'Cloud E-Commerce',
    description: 'إدارة المتاجر السحابية، المنتجات، والطلبات الإلكترونية',
    category: 'commerce',
    status: 'active',
  ...
  },
  {
    id: 'etrack',
    name: 'eTrack',
    nameEn: 'Shipments & Logistics',
    description: 'نظام تتبع الشحنات واللوجستيات المباشر وإشعارات التسليم',
    category: 'commerce',
    status: 'active',
    icon: <Truck size={20} />,
    href: '/services#etrack',
    accentColor: '#FFFFFF',
  },
  {
    id: 'eshield',

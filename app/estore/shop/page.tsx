...
export default function EstoreShopClientPage() {
  ...
  return (
    <div className="white-app-container">
      ...
      <header className="white-navbar">
        <div className="white-navbar-brand">
          ...
          <Link href="/estore/shop" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
            ...
            <div>
              <span style={{ fontSize: '15px', fontWeight: 800, color: '#09090B' }}>eStore Luxury</span>
              <span style={{ fontSize: '10.5px', color: '#71717A', marginRight: '6px' }}>متجر الزبائن الفاخر</span>
            </div>
          </Link>
        </div>
        ...
        <div className="white-navbar-actions">
          <div style={{ position: 'relative', width: '220px' }} className="phone-hidden">
            <input
              type="text"
              value={searchQuery}
      ...
      <main className="estore-container">
        ...
        <div className="estore-hero">
          ...
          <p style={{
            ...
            اكتشف تشكيلتنا المنتقاة بعناية فائقة. توصيل سريع وموثوق إلى كافة محافظات العراق، مع ضمان الاستبدال المباشر والدفع عند الاستلام أو عبر كي كارد.
          </p>

          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginTop: '6px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12.5px', color: '#27272A' }}>
              <Truck size={16} color="#059669" />
              <span>شحن آمن وسريع</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12.5px', color: '#27272A' }}>
              <ShieldCheck size={16} color="#059669" />
              <span>ضمان جودة eShamikh</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12.5px', color: '#27272A' }}>
          ...
          <div className="elink-tabs-row">
            {[
              ...
              <button
                ...
                className={`elink-tab ${selectedCategory === tab.id ? 'active' : ''}`}
              >
                {tab.label}
              </button>
            ))}
        ...
        {/* Product Grid */}
        <div className="estore-product-grid">
          {filteredProducts.map(product => (
            <div key={product.id} className="estore-product-card">
              {/* Product Image Container */}
              <div className="estore-product-image-wrap">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={product.image}
                  alt={product.title}
                  className="estore-product-image"
                  loading="lazy"
                />

                {/* Floating Pill Price Badge (Apple / Vercel style) */}
                <div className="estore-price-pill">
                  {product.price.toLocaleString()} د.ع
                </div>
              </div>

              {/* Product Content Info */}
              <div className="estore-product-info">
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <span style={{ fontSize: '11px', fontWeight: 600, color: '#71717A' }}>
                    {product.category}
                  </span>
                  <span style={{ fontSize: '11px', color: '#C5A059', fontWeight: 700 }}>
                    ★ {product.rating}
                  </span>
                </div>

                <h3 className="estore-product-title">{product.title}</h3>
                <p className="estore-product-desc">{product.description}</p>
              ...
              {checkoutComplete ? (
                <div style={{
                  ...
                  <p style={{ fontSize: '13px', color: '#71717A', margin: 0 }}>
                    سيصلك إشعار عبر الهاتف برقم البوليصة لتتبع الشحنة مع مندوب التوصيل.
                  </p>
                </div>
              ) : cart.length > 0 ? (
                cart.map(item => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: '12px', fontWeight: 700, color: '#059669', marginTop: '2px', fontFamily: 'JetBrains Mono' }}>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '11.5px' }}>اختر منتجاً لتجربة عملية الشراء الفاخرة</span>
                </div>
              )}
            </div>
            ...
            {cart.length > 0 && !checkoutComplete && (
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '13px', color: '#71717A' }}>
                  ...
                  <span style={{ fontFamily: 'JetBrains Mono', fontWeight: 600, color: '#09090B' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '13px', color: '#71717A' }}>
                  ...
                  <span style={{ color: '#059669', fontWeight: 600 }}>مجاني (عرض خاص)</span>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '15px', fontWeight: 800, color: '#09090B' }}>
                  ...
                  <span style={{ fontFamily: 'JetBrains Mono', color: '#09090B' }}>
                    {cartTotal.toLocaleString()} د.ع
                  </span>
                </div>
                ...
                <button
                  ...
                  className="btn-white-primary"
                  style={{ width: '100%', padding: '13px', borderRadius: '12px', fontSize: '14px', marginTop: '4px' }}
                >
                  <CreditCard size={16} />
      ...
      {/* Quick View Modal */}
      {quickViewProduct && (
        <div className="settings-modal-backdrop" onClick={() => setQuickViewProduct(null)}>
          <div
          ...
          >
            <div className="settings-modal-header">
              ...
              <button className="settings-modal-close-btn" onClick={() => setQuickViewProduct(null)}>
                <X size={16} />
              </button>
            </div>
            ...
            <div style={{ padding: '24px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <span className="badge-pill neutral" style={{ width: 'fit-content' }}>
                ...
                <div style={{ fontSize: '22px', fontWeight: 800, color: '#09090B', fontFamily: 'JetBrains Mono' }}>
